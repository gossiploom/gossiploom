...
(
  ...
  'An anonymous source from Capitol Hill has revealed shocking behind-the-scenes drama that''s been brewing for months. The tensions between party leaders have reached a boiling point, with heated arguments happening during what were supposed to be peaceful strategy meetings.

According to our source, the disagreements stem from fundamental differences in approach to upcoming legislation. "You wouldn''t believe the things being said in those closed-door meetings," our insider revealed. "It''s like watching a soap opera unfold."
...
Sources close to the situation say that the conflict has gotten so intense that some members are considering dramatic moves that could reshape the entire political landscape.',
  'Capitol Hill insider spills tea on explosive party drama that''s been brewing behind closed doors...',
  'Politics',
  'Political Insider',
  NULL,
  false,
...
(
  'Campaign Manager''s Shocking Confession About Election Strategy',
...
(
  'Governor''s Family Feud Explodes Into Public View',
...
The conflict apparently centers around business deals that went wrong and allegations of using political influence for personal gain. "It''s gotten ugly," says a family friend who wished to remain anonymous.

The situation became public when the governor''s sibling posted a series of cryptic social media messages that many interpreted as veiled threats. This led to a very public back-and-forth that has political observers scratching their heads.

The drama has escalated to the point where other family members are being forced to choose sides. Legal experts suggest that this could potentially impact the governor''s political future if more details emerge.',
  'Governor''s family drama spills into public in the messiest political scandal of the year...',
  'Politics',
  'Political Reporter',
  NULL,
  false,
